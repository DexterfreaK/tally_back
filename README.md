...
This project is a coding platform built during the Tally Codebrewers hackathon in a span of 48 hours built with Node.js and Next.js. It features a backend powered by Node.js, PostgreSQL as the database, and Docker for code execution using Dockerode. The frontend is built with Next.js and styled using ShadCN.

### Link for the presentation - [Link](https://drive.google.com/file/d/1_lIZp1gsngGv1QrOGadXydkq0Gg1SkxZ/view?usp=sharing)
